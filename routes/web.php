...
/*
 Product Routes
 All the Routes for our Products for front-end
*/
...
Route::group(['prefix' => 'admin'], function() {
    ...
    Route::post('/password/resetPost', 'Auth\Admin\ForgotPasswordController@sendResetLinkEmail')->name('admin.passwords.email');
