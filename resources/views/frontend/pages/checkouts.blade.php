...
@section('content')
    ...
    <div class="container margin-top-20">
        <div class="card card-body">
            ...
            <p>
                <a href="{{route('carts')}}" onMouseOver="this.style.color='#d90000'"
                   onMouseOut="this.style.color='#2d7fff'"><strong><i class="fa fa-pencil" aria-hidden="true" ></i>
                         Change Cart Items</strong></a>
            </p>
        </div>

        <div class="card card-body mt-2">
            <h2>Check Shipping & Billing Address</h2>
            <hr>
            <form method="POST" action="{{ route('checkouts.store') }}">
                @csrf
                <div class="form-group row">
                    <label for="name" class="col-md-4 col-form-label text-md-right">Receiver Name <strong><sup style="color:#d90000; font-size: large">*</sup></strong></label>
                ...
                <div class="form-group row">
                    <label for="email" class="col-md-4 col-form-label text-md-right">Email Address <strong><sup style="color:#d90000; font-size: large">*</sup></strong></label>
                ...
                <div class="form-group row">
                    <label for="phone_no" class="col-md-4 col-form-label text-md-right">Phone Number <strong><sup style="color:#d90000; font-size: large">*</sup></strong></label>
                ...
                <div class="form-group row">
                    <label for="message" class="col-md-4 col-form-label text-md-right">Additional Message <strong><sup style="color:#d90000; font-style: inherit; font-size: small">(optional)</sup></strong></label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="shipping_address" class="col-md-4 col-form-label text-md-right">Shipping Address <strong><sup style="color:#d90000; font-size: large">*</sup></strong></label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="payment_method" class="col-md-4 col-form-label text-md-right">Payment Method <strong><sup style="color:#d90000; font-size: large">*</sup></strong></label>
                    <div class="col-md-6">
